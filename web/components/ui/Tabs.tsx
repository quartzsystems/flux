...
/// Underline tab bar, ported verbatim from Quartz Command / Lumen so all three
/// products' consoles use the same control: a full-width bottom border with the
/// active tab underlined in the accent colour. `trailing` renders at the right
/// edge without breaking the underline.
///
